...
Promise.all([fetch("https://smuknu.webmcdm.dk/products",
    ...
    .then(function (KT) {
        ...
        for (let I = 0; I < KT.length; I++) (K +=
            `<div class='Products'>
                <img class='Products-image' src='${KT[I].image}'>${"" == KT[I].discountInPercent ? "" :/* <---- 
                Jeg tjekker om strengen fra id'et discountInPercent er tomt. Hvis dette er TRUE så SKAL strengen være tom "". 
                Efter den tomme streng kommer vores conditional operator, der siger at hvis værdien er FALSE skal tallet fra discountInPercent 
                i REST API'en printes ud i browseren */
